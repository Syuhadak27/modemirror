    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/modemirror">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/modemirror"><i class="fab fa-github"></i></a>
        <a href="https://t.me/modemirror"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
    ...
    <div class="content">
        ...
        <a href="https://telegram.me/modemirror" style="text-decoration: none;">
            <button class="button">Join Updates Channel Now</button>
        </a>
    </div>
    <div class="footer">
© 2022-23 modemirror. All Rights Reserved.
    </div>
</body>
</html>
"""
